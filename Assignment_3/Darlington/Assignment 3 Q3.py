...
# ==========================================
# Step 2 & 3: RBF SVM Grid Search & Retraining
# ==========================================
...
grid_search = GridSearchCV(svm_rbf, param_grid, cv=5, scoring='balanced_accuracy')
...
print("\n--- Performance Metrics on Test Set (RBF Kernel) ---")
