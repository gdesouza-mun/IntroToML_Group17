...
\begin{paracol}{2}
  ...
  The resulted boundary regions overlaid with
  ...
  For the \textbf{high values} of k, the testing error was also over 20\% worst then the best
  ...
  generate a similar boundary region, as the kNN classifier is low variance for high values of k.
